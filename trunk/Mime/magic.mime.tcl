...
if {[S 0 == MAS_UTrack_V00 ]} {if {[S 14 > /0 ]} {emit audio/x-mod}
}
...
if {[S 0 == <?xml ]} {if {[S 38 == {<\!DOCTYPE\040svg} ]} {emit image/svg+xml}
}
...
if {[S 0 == RIFF ]} {if {[S 8 == WAVE ]} {emit audio/x-wav}
...
if {[S 0 == FWS ]} {if {[N c 3 x {} ]} {emit application/x-shockwave-flash}
}
if {[S 0 == BZh ]} {emit application/x-bzip2}
if {[S 0 == {\#VRML\ V1.0\ ascii} ]} {emit model/vrml}
if {[S 0 == {\#VRML\ V2.0\ utf8} ]} {emit model/vrml}
if {[S 0 == DOC ]} {if {[N c 43 == 0x14 ]} {emit application/ichitaro4}
if {[S 144 == JDASH ]} {emit application/ichitaro4}
}
if {[S 0 == DOC ]} {if {[N c 43 == 0x15 ]} {emit application/ichitaro5}
}
if {[S 0 == DOC ]} {if {[N c 43 == 0x16 ]} {emit application/ichitaro6}
}
...
if {[S 0 == {\320\317\021\340\241\261\032\341} ]} {if {[S 546 == bjbj ]} {emit application/msword}
...
if {[S 0 == MZ ]} {if {[S 24 == @ ]} {emit application/octet-stream}
}
if {[S 0 == MZ ]} {if {[S 30 == {Copyright\ 1989-1990\ PKWARE\ Inc.} ]} {emit application/x-zip}
}
if {[S 0 == MZ ]} {if {[S 30 == {PKLITE\ Copr.} ]} {emit application/x-zip}
}
if {[S 0 == MZ ]} {if {[S 36 == {LHa's\ SFX} ]} {emit application/x-lha}
}
if {[S 0 == MZ ]} {emit application/octet-stream}
if {[S 2 == -lh ]} {if {[S 6 == - ]} {emit application/x-lha}
}
